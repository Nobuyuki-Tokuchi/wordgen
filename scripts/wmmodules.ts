...
interface EquivalentSetting {
	equvalentsList: EquivalentDictionary;
 ...
 * 訳語辞書
 */
interface EquivalentDictionary {
	name: string;
	data: { equivalents: string[], content: any }[];
}
...
class WMModules {
	 ...
	 * @return 訳語一覧のデフォルト値
	 */
	static defaultEquivalents(): EquivalentDictionary {
		return <EquivalentDictionary> Object.create(WMModules.EQUIVALENTS);
	}
	 ...
	 * 訳語一覧
	 */
	private static EQUIVALENTS = <EquivalentDictionary> {
		"name" : "S語根",
		"data" : [
			{
